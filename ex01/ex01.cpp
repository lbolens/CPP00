...
/*   Updated: 2025/10/21 10:19:13 by lbolens          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "PhoneBook.hpp"

PhoneBook::PhoneBook() : nbr(0), next(0) {}

std::string Contacts::truncate(const std::string &str) const {
    if (str.length() > 10)
...
void Contacts::print_contacts(int index) const {
